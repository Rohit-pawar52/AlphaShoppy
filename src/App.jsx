...
import AllCategoriesShoppy from './Filter-components/all-categories/AllCategoriesShoppy';
...
import NavbarCategory from './Filter-components/NavbarCategory/NavbarCategory';
...
import ProductDescription from './MainComponents/product-shoppy/product-description/ProductDescription';
const App = () => {
  return (
    <>
    <Router>
